...
* La documentation ruby se trouve sur [**ruby-doc.com**](ruby-doc.com)
...
Les expressions rationnelles sont exprimé entre deux `/`. Allez sur [Rubular.com](www.rubular.com) pour acceder à leur generateur de regex ruby.
...
il faut aller sur [RubyGems.org](rubygems.org) qui references les bibliotheques Gems de ruby, ici dans l'exemple on recupere le gem de twitter, c'est une 
