...
![archi-micro-services.png](archi-micro-services.png)

![archi-micro-service-ex.png](archi-micro-service-ex.png)
...
![concept essentiels](concept-essentiels.png)
...
![cluster swarm](cluster-swarm.png)
...
[PDF : Configuration du Daemon](configuration-daemon.pdf)

### Communication client / serveur

[PDF : Communication entre Client/Daemon](communication-client-daemon.pdf)
...
- Container lance en foregrond par defaut
...
![commande inspect](cmd-inspect.png)
...
**Tant aue le process `PID 1` est en cours d'execution le container reste actif**
...
- [PDF: Exercices commandes de base](base-commands.pdf)
...
- [PDF : Layer associee au container](container-layer.pdf)
- [PDF : Systeme de fichiers d'une image](image-filesystem.pdf)
...
- [PDF : Creation from container](creation-from-container.pdf)
- [PDF : Creation dockerfile pong](creation-Dockerfile-pong.pdf)
...
- [PDF : Entrypoint vs Cmd](entrypoint_vs_cmd.pdf)
...
- [PDF : multistage build GO](multi-stage-build-GO.pdf)
...
- [PDF : create repo on dockerhub](create-a-repo-on-Docker-Hub.pdf)
...
- [PDF : registry open source](setup-open-source-registry.pdf)

### Exercice: Configuration du registry open source

- [PDF : configuration du registry open source](configure-open-source-registry.pdf)
...
[PDF : creation local](creation-local.pdf)

### Exercice: Creation sur DigitalOcean

[PDF : creation sur digital ocean](creation-DigitalOcean.pdf)
...
![vue d'ensemble Swarm mode](swarm1.png)
...
- [PDF : creation en local](swarm-creation-local.pdf)


### Exercice: Creation sur DigitalOcean

- [PDF : creation sur DigitalOcean](swarm-creation-DigitalOcean)
...
- [Creation d'un service](service-creation.pdf)
...
- [PDF : Rolling update and rollback](service-update-rollback.pdf)
...
- [PDF : Utilisation des secrets et configs](config-et-secret.pdf)
...
- [PDF : Deploiement de la stack TICK](stack-TICK.pdf)
...
![Routing mesh](routing-mesh.png)

![Routing mesh details](routing-mesh2.png)
...
![Swarm architecture](swarm-archi.png)
...
[PDF : Tolerance aux pannes](tolerance-pannes.pdf)
...
![Container network model](CNM.png)
...
![user defined bridge](user-defined-bridge.png)

Les containers attaches au nouveau bridge peuvent communiquer entre eux via leur nom:

![exemple user definded bridge](ex-user-defined-bridge.png)
...
- [PDF : Network sur un hote](base-networks.pdf)
...
[Networks dans un Swarm](swarm-networks.pdf)
...
[PDF : CIS Docker Benchmark](CIS-Docker-CE-Benchmark-v1.1.0.pdf)
...
[PDF : explication fonctionnement SELinux](selinux-coloring-book.pdf)
